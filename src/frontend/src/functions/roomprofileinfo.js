...
export async function updateRoomProfileInfo(room_type, room_type_2nd, block, block_2nd, level_range,
    ...
    var data = JSON.stringify({
        "room_type": room_type,
        "room_type_2nd": room_type_2nd,
        "block": block,
        "block_2nd": block_2nd,
        "level_range": level_range,
        "window_facing": window_facing,
        "near_to_lift": near_to_lift,
        "near_to_washroom": near_to_washroom,
        "level_has_pantry": level_has_pantry,
        "level_has_mr": level_has_mr,
        "level_has_gsr": level_has_gsr,
        "level_has_rr": level_has_rr,
