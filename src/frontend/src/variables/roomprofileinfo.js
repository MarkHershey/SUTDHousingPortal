...
export async function updateRoomProfileInfo(room_type,room_type_2nd,block,block_2nd,level_range,
    ...
    "near_to_lift":near_to_lift,"near_to_washroom":near_to_washroom,"level_has_pantry":level_has_pantry,
    "level_has_mr":level_has_mr,"level_has_gsr":level_has_gsr,"level_has_rr":level_has_rr,"weightage_order":weightage_order});

    var config = {
    method: 'put',
    url: 'http://esc.dev.markhh.com/api/students/'+getUsername()+'/update_room_profile',
    headers: { 
