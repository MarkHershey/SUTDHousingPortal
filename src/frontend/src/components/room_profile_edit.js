        ...
        return (
            ...
            <bs.Container>
                ...
                <bs.Row>
                    <bs.Col>
                        <div className="input-group mb-3">
                            ...
                            <input id="pref_student_id" type="text" className="form-control" placeholder="Student ID"
                    ...
                    <bs.Col>
                        <div className="input-group mb-3">
                            ...
                            <input id="pref_student_id_block" type="text" className="form-control" placeholder="Student ID"
                                    aria-describedby="basic-addon1" onChange={(e)=>this.handleChange(e)}/>
                        </div>
                    </bs.Col>
                </bs.Row>
                ...
                <bs.Row>
                    <bs.Col>
                        <div className="form-check" align="left" onChange={(e)=>this.handleChange(e)}>
                            <input id="pref_block_55" className="form-check-input" type="radio" name="block"
                        ...
                        <div className="form-check" align="left" onChange={(e)=>this.handleChange(e)}>
                            <input id="pref_block_57" className="form-check-input" type="radio" name="block" 
                        ...
                        <div className="form-check" align="left" onChange={(e)=>this.handleChange(e)}>
                            <input id="pref_block_59" className="form-check-input" type="radio" name="block"
                        ...
                        <div className="form-check" align="left" onChange={(e)=>this.handleChange(e)}>
                            <input id="pref_block_any" className="form-check-input" type="radio" name="block"
                    ...
                    <bs.Col>
                        <div className="form-check" align="left" onChange={(e)=>this.handleChange(e)}>
                            <input id="pref_2nd_block_55" className="form-check-input" type="radio" name="block_2nd"
                        ...
                        <div className="form-check" align="left" onChange={(e)=>this.handleChange(e)}>
                            <input id="pref_2nd_block_57" className="form-check-input" type="radio" name="block_2nd" 
                        ...
                        <div className="form-check" align="left" onChange={(e)=>this.handleChange(e)}>
                            <input id="pref_2nd_block_59" className="form-check-input" type="radio" name="block_2nd"
                        ...
                        <div className="form-check" align="left" onChange={(e)=>this.handleChange(e)}>
                            <input id="pref_2nd_block_any" className="form-check-input" type="radio" name="block_2nd"
                ...
                <bs.Row>
                    <bs.Col>
                        <div className="form-check" align="left" onChange={(e)=>this.handleChange(e)}>
                            <input id="pref_level_lower" className="form-check-input" type="radio" name="level_range"
                        ...
                        <div className="form-check" align="left" onChange={(e)=>this.handleChange(e)}>
                            <input id="pref_level_middle" className="form-check-input" type="radio" name="level_range"
                        ...
                        <div className="form-check" align="left" onChange={(e)=>this.handleChange(e)}>
                            <input id="pref_level_higher" className="form-check-input" type="radio" name="level_range"
                        ...
                        <div className="form-check" align="left" onChange={(e)=>this.handleChange(e)}>
                            <input id="pref_level_any" className="form-check-input" type="radio" name="level_range"
                    ...
                    <bs.Col>
                        <div className="form-check" align="left" onChange={(e)=>this.handleChange(e)}>
                            <input id="pref_lift_yes" className="form-check-input" type="radio" name="near_to_lift"
                        ...
                        <div className="form-check" align="left" onChange={(e)=>this.handleChange(e)}>
                            <input id="pref_lift_no" className="form-check-input" type="radio" name="near_to_lift"
                        ...
                        <div className="form-check" align="left" onChange={(e)=>this.handleChange(e)}>
                            <input id="pref_lift_any" className="form-check-input" type="radio" name="near_to_lift"
                ...
                <bs.Row>
                    <bs.Col>
                        <div className="form-check" align="left" onChange={(e)=>this.handleChange(e)}>
                            <input id="pref_pantry_yes" className="form-check-input" type="radio" name="level_has_pantry"
                        ...
                        <div className="form-check" align="left" onChange={(e)=>this.handleChange(e)}>
                            <input id="pref_pantry_no" className="form-check-input" type="radio" name="level_has_pantry"
                        ...
                        <div className="form-check" align="left" onChange={(e)=>this.handleChange(e)}>
                            <input id="pref_pantry_any" className="form-check-input" type="radio" name="level_has_pantry"
                    ...
                    <bs.Col>
                        <div className="form-check" align="left" onChange={(e)=>this.handleChange(e)}>
                            <input id="pref_washroom_yes" className="form-check-input" type="radio" name="near_to_washroom"
                        ...
                        <div className="form-check" align="left" onChange={(e)=>this.handleChange(e)}>
                            <input id="pref_washroom_no" className="form-check-input" type="radio" name="near_to_washroom"
                        ...
                        <div className="form-check" align="left" onChange={(e)=>this.handleChange(e)}>
                            <input id="pref_washroom_any" className="form-check-input" type="radio" name="near_to_washroom"
                ...
                <bs.Row>
                    <bs.Col>
                        <div className="form-check" align="left" onChange={(e)=>this.handleChange(e)}>
                            <input id="pref_gsr_yes" className="form-check-input" type="radio" name="level_has_gsr"
                        ...
                        <div className="form-check" align="left" onChange={(e)=>this.handleChange(e)}>
                            <input id="pref_gsr_no" className="form-check-input" type="radio" name="level_has_gsr"
                        ...
                        <div className="form-check" align="left" onChange={(e)=>this.handleChange(e)}>
                            <input id="pref_gsr_any" className="form-check-input" type="radio" name="level_has_gsr"
                    ...
                    <bs.Col>
                        <div className="form-check" align="left" onChange={(e)=>this.handleChange(e)}>
                            <input id="pref_rr_yes" className="form-check-input" type="radio" name="level_has_rr"
                        ...
                        <div className="form-check" align="left" onChange={(e)=>this.handleChange(e)}>
                            <input id="pref_rr_no" className="form-check-input" type="radio" name="level_has_rr"
                        ...
                        <div className="form-check" align="left" onChange={(e)=>this.handleChange(e)}>
                            <input id="pref_rr_any" className="form-check-input" type="radio" name="level_has_rr"
                ...
                <bs.Row>
                    <bs.Col>
                        <div className="form-check" align="left" onChange={(e)=>this.handleChange(e)}>
                            <input id="pref_mr_yes" className="form-check-input" type="radio" name="level_has_mr"
                        ...
                        <div className="form-check" align="left" onChange={(e)=>this.handleChange(e)}>
                            <input id="pref_mr_no" className="form-check-input" type="radio" name="level_has_mr"
                        ...
                        <div className="form-check" align="left" onChange={(e)=>this.handleChange(e)}>
                            <input id="pref_mr_any" className="form-check-input" type="radio" name="level_has_mr"
                    ...
                    <bs.Col>
                        <div className="form-check" align="left" onChange={(e)=>this.handleChange(e)}>
                            <input id="pref_window_campus" className="form-check-input" type="radio" name="window_facing"
                        ...
                        <div className="form-check" align="left" onChange={(e)=>this.handleChange(e)}>
                            <input id="pref_window_airport" className="form-check-input" type="radio" name="window_facing"
                        ...
                        <div className="form-check" align="left" onChange={(e)=>this.handleChange(e)}>
                            <input id="pref_window_building" className="form-check-input" type="radio" name="window_facing"
                        ...
                        <div className="form-check" align="left" onChange={(e)=>this.handleChange(e)}>
                            <input id="pref_window_any" className="form-check-input" type="radio" name="window_facing"
                ...
                <bs.Row>
                    <bs.Col>
                        <div className="form-check" align="left" onChange={(e)=>this.handleChange(e)}>
                            <input id="pref_room_single" className="form-check-input" type="radio" name="room_type"
                        ...
                        <div className="form-check" align="left" onChange={(e)=>this.handleChange(e)}>
                            <input id="pref_room_double" className="form-check-input" type="radio" name="room_type"
                        ...
                        <div className="form-check" align="left" onChange={(e)=>this.handleChange(e)}>
                            <input id="pref_room_ensuite" className="form-check-input" type="radio" name="room_type"
                        ...
                        <div className="form-check" align="left" onChange={(e)=>this.handleChange(e)}>
                            <input id="pref_room_any" className="form-check-input" type="radio" name="room_type"
                    ...
                    <bs.Col>
                        <div className="form-check" align="left" onChange={(e)=>this.handleChange(e)}>
                            <input id="pref_2nd_room_single" className="form-check-input" type="radio" name="room_type_2nd"
                        ...
                        <div className="form-check" align="left" onChange={(e)=>this.handleChange(e)}>
                            <input id="pref_2nd_room_double" className="form-check-input" type="radio" name="room_type_2nd"
                        ...
                        <div className="form-check" align="left" onChange={(e)=>this.handleChange(e)}>
                            <input id="pref_2nd_room_ensuite" className="form-check-input" type="radio" name="room_type_2nd"
                        ...
                        <div className="form-check" align="left" onChange={(e)=>this.handleChange(e)}>
                            <input id="pref_2nd_room_any" className="form-check-input" type="radio" name="room_type_2nd"
